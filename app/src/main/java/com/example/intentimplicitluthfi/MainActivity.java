package com.example.intentimplicitluthfi;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        input_web =  findViewById(R.id.input_web);
        input_share_text =  findViewById(R.id.input_share_text);
        input_location =  findViewById(R.id.input_location);
        input_dial =  findViewById(R.id.input_dial);
        image_camera_view =  findViewById(R.id.image_camera_view);
